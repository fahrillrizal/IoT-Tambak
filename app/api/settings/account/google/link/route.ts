...
// POST - Link Google account to current user (manual linking via token)
export async function POST(request: Request) {
  try {
    ...
    // Cek apakah akun Google ini sudah terhubung ke user lain
    ...
    // Link akun Google ke user saat ini

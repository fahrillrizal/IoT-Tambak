...
export default function HistoryPage() {
  ...
  return (
    <DashboardLayout activeMenu="history" notificationCount={totalNotifications}>
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className={`p-2 rounded-lg ${
                      log.type === "alert" ? "bg-yellow-100" :
                      log.type === "reading" ? "bg-blue-100" : "bg-purple-100"
                    }`}>
                      <Icon className={`h-4 w-4 ${
                        log.type === "alert" ? "text-yellow-600" :
                        log.type === "reading" ? "text-blue-600" : "text-purple-600"
                      }`} />
                    </div>
                    <div>
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${SEVERITY_STYLES[log.severity]}`}>
                    {log.severity === "high" ? "Tinggi" :
                     log.severity === "medium" ? "Sedang" :
                     log.severity === "normal" ? "Normal" : "Info"}
                  </span>
                </div>
              );
            })}
